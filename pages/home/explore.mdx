...
<Callout>
On-chain consumer contracts are being rebuilt, and their documentation will return when the new contracts ship. In the meantime, inferences can be consumed through the [Allora API](/devs/consumers/allora-api-endpoint).
</Callout>
