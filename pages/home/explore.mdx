...
<Cards>
  ...
  <Card title="Model Forge Competition Info" href="/devs/get-started/model-forge" />
  <Card title="Query Inferences" href="/devs/get-started/query-network-data" />
</Cards>

## Participants

[Participants](/devs/get-started/overview) can permissionlessly integrate with Allora to consume, supply, or verify the accuracy of exchanged inferences.
...
<Cards>
  <Card 
    ...
    href="http://localhost:4000/basic-coin-price-prediction"
  >
