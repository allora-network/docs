...
#### Network Inference API Breaking Changes
...
- **Removed Network Inference On-chain Computations**: weights and confidence intervals are no longer provided on-chain - they can be calculated offchain out of chain data. 

#### Stability and Security

- **More Consistent Submission Window Handling**: Submission window boundaries are now correctly and consistently applied under all scenarios.
