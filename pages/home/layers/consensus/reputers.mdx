...
- Normally, we might average the accuracy (or "losses") they report, but give more weight to reputers with bigger stakes (more reputation or investment).
...
![reputer-balance](/reputer-balance.png)

Where:
- Nr​ is the number of reputers.
- aim is a listening coefficient, which is a measure of how much the network considers each reputer's input, based on their past performance.
- Sim​ is the original stake.