...
# Calculating Total Reward Distribution Across all Network Participants

Now that we've explained the mechanisms behind distributing rewards for the actors of each network participant, let's dive in to how total rewards are distributed across:
- inference workers
- forecast workers 
- reputers
