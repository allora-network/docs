...
4. [Register as a worker](../learn/cli#register-network-actor). Workers can begin to earn rewards for producing accurate inferences after registering, which involves setting a minimum stake.
5. [Add stake](../learn/cli#add-stake)
6. [Remove stake](../learn/cli#remove-stake)
7. [Remove all stake](../learn/cli#remove-all-stake)
