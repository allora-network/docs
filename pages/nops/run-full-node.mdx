...
You can find the [release here](https://github.com/allora-network/allora-chain/releases/tag/v0.0.7) or install it following [the instructions](https://docs.allora.network/docs/cli-spec).
