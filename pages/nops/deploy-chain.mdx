...
Different actors interact with the Allora Appchain for different reasons. They do so via a standard client connection (such as <a href="https://tutorials.cosmos.network/tutorials/7-cosmjs/1-cosmjs-intro.html" target="_blank">CosmJS</a>) or the [Appchain CLI](cli-spec).
...
Upshot team uses a <a href="https://upshot-tech.github.io/helm-charts/" target="_blank">universal-helm</a> chart to deploy applications into kubernetes clusters.  
