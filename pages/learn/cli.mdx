...
```bash
  ...
  mv: rename /tmp/allorad to /Users/{YOUR_USERNAME}/.local/bin/allorad: No such file or directory
  chmod: /Users/{YOUR_USERNAME}/.local/bin/allorad: No such file or directory
  Installation complete. The allorad is now available in /Users/{YOUR_USERNAME}/.local/bin
