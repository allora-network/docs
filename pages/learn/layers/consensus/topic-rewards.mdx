---
title: Calculating Topic Reward Distribution Across all Network Participants
description: How topic rewards are distributed across inference workers, forecast workers, and reputers.
