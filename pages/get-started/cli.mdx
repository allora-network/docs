...
The command below installs <Version of="chain-testnet"/>, the version currently deployed on the testnet. If you are targeting mainnet, pass <Version of="chain-mainnet"/> instead — see [Networks](/reference/networks) for the version deployed on each network.
