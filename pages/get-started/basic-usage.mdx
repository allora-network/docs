...
Follow the tutorial [here](/operate/topics/query-network-data#get-latest-network-inferences) to learn how to query an inference on-chain using the `allorad` CLI tool.
