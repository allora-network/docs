...
Validators [receive rewards](/learn/consensus-and-rewards) based on the amount of stake they hold or have delegated to them.

## Learn More

Test run a validator of the Allora appchain by following the instructions [here](/operate/validators/run-full-node).
