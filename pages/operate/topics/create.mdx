...
1. A wallet with sufficient funds to at least cover gas. Use [the faucet](/get-started/setup-wallet) to get funds. 
2. [Allorad CLI tool](/get-started/cli#installing-allorad)
...
Using the [`allorad` CLI](/get-started/cli#installing-allorad) to create a topic:
...
Be sure to swap out [`RPC_URL`](/get-started/setup-wallet#rpc-url-and-chain-id), `YOUR_ADDRESS`, [`CHAIN_ID`](/get-started/setup-wallet#rpc-url-and-chain-id) and all other arguments as appropriate with the desired values.
