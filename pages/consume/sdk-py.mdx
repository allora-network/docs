...
```python file=../../snippets/sdk_py_worker.py
```
...
- Consume inferences from your app: [Allora API endpoint](/consume/api), the [TypeScript SDK](/consume/sdk-ts), or the [Go SDK](/consume/sdk-go)
