---
title: Eliza Allora Plugin ✨
description: The Allora Network plugin for Eliza enables seamless integration with Allora's powerful AI inference platform.
...
- `ALLORA_API_KEY`: Your Allora API key. To generate an API key, sign up for a free account at the [Allora Developer Portal](https://developer.allora.network) and create a key from your dashboard.
