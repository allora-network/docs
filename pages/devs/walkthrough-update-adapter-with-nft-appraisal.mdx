...
2. [Call the Adapter Asset Appraisals API](./offchain-query-existing-workers#nft-appraisal-id3) using the `topicId` found in the [deployed topics list](./existing-topics) and the correct `chainId`. For example, if you use sepolia, you would provide `ethereum-11155111`. Specify the `nftId` that you would like data for at the end of the address string for the nft collection, like `0x42069abfe407c60cf4ae4112bedead391dba1cdb/1465`
