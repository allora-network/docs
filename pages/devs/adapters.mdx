...
Adapter contracts are essential for bringing Allora Network prices on-chain. You can find the code repository containing the contracts <a href="https://github.com/allora-network/allora-adapter" target="_blank">here</a>.

## Consuming Data Feeds from Allora

Below is an example of requesting a price from Allora. This example code can be found <a href="https://github.com/allora-network/allora-adapter/blob/main/src/examples/AlloraAdapterBringPredictionOnChainExample.sol" target="_blank">here</a>.
