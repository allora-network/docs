...
You can refer if needed to the [CLI spec here](/devs/get-started/installation/cli) and the [repo's README.md](https://github.com/allora-network/allora-chain?tab=readme-ov-file#documentation).
