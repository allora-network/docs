...
Below is a sample script to help automate the state sync process. You'll need to choose an RPC endpoint from the list above (or another trusted source) and set it in the script.
