...
**Example:**
```bash
allorad q emissions latest-available-network-inferences 1 --node https://rpc.testnet.allora.network
```
...
// Example usage
getLatestInference(1, 'https://rpc.testnet.allora.network')
  .then(data => {
...
# Example usage
try:
    data = get_latest_inference(1, "https://rpc.testnet.allora.network")
...
- Testnet: `https://rpc.testnet.allora.network`

For a complete list of available RPC endpoints and their status, please contact the Allora team.
