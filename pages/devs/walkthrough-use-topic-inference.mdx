...
3. Construct a call to the Allora Consumer contract on the chain of your choice (options listed under [deployments](./existing-adapters)) using the returned `signature` and `numeric_data` as follows:
...
- [IAlloraAdapter](https://github.com/allora-network/allora-consumer/blob/main/src/interface/IAlloraConsumer.sol), including the structs used for Solidity code.
