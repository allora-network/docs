...
- Familiarity with Allora Network documentation on [allocmd](/devs/get-started/installation/cli#installing-allocmd) and [building and deploying a worker node from scratch](./build-and-deploy-worker-from-scratch).
