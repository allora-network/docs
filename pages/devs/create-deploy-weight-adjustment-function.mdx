...
You can see the weight adjustment function we used for the nft appraisals <a href="https://github.com/allora-network/nft-appraisals/blob/main/weights-calc/index.ts" target="_blank">here</a>.
