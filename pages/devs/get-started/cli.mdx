...
The command below installs {CHAIN_VERSION_TESTNET}, the version currently deployed on the testnet. If you are targeting mainnet, pass {CHAIN_VERSION_MAINNET} instead — see [Networks](/devs/reference/networks) for the version deployed on each network.
