...
| 29 | USDC/ETH Volume Prediction | `USDC/ETH` | `5min` | Mean Squared Error | USDC/ETH 5min Volume Prediction |
| 28 | ETH Volatility Prediction | `ETH` | `5min` | Mean Squared Error | ETH 5min Volatility Prediction |
