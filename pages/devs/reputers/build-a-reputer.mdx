...
To run a reputer only, configure just the `reputer` array — the `worker` section of the example config is for [inference workers](/devs/workers/deploy-worker) and can be removed.
