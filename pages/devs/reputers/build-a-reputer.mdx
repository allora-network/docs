...
- `addressKeyName` and `addressRestoreMnemonic`: the name and mnemonic of your [wallet](/devs/get-started/setup-wallet). Leave them empty to have keys created for you automatically — the generated address is written to `./data/env_file`, and you will need to fund it before the node can register and stake.
