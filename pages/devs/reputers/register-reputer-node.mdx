...
- ```Text bash
  ...
  ```
- Fund the Key on the network environment you plan to run the reputer, (i.e. testnet faucet, the reputer will be running on testnet). One can obtain funds on our testnet through our faucet as [explained here](/devs/get-started/setup-wallet#add-faucet-funds).
