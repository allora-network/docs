...
This diagram illustrates the architecture of the Allora Network, highlighting the integration between the Allora Network (built on the Cosmos AppChain) and an AWS-based infrastructure for handling inference requests. 

![node-runners](/node-runners.png)
