...
1. Make sure you have checked the documentation on [Deploying a Worker Node](deploy-a-worker-node-with-allora-wkr).
...
3. Provide a valid `UPSHOT_API_TOKEN` env var inside a newly created `.env` file following the structure of the `.env_example` file. You can create an Upshot API key <a href="https://developer.upshot.xyz/" target="_blank">here</a>.
