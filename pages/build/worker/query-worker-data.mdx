...
Below is a list of commands to understand how to pull information about workers via [`allorad`](/get-started/cli#installing-allorad):
...
- **Description:** Return scores for a worker at a block height.
    - Scores determine how [worker rewards](/learn/consensus-and-rewards#worker-rewards) are paid out.
...
### Use Case:
**Why use it?**  
- Use this command to assess the [regret](/learn/key-terms#regrets) associated with incorporating an inferer’s naive inference into a batch. Useful for analyzing how poorly an inference may perform within the context of the network’s aggregate inference for a topic.
