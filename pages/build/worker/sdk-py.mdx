...
- Run the other worker roles — `AlloraWorker.forecaster(...)` and `AlloraWorker.reputer(...)`: [Build and Deploy a Forecaster](/build/forecaster) and [Build a Reputer](/build/reputer/build-a-reputer)
