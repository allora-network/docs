---
title: How to Query Worker EMA Scores
description: The EMA score reflects a worker's performance over time for a given topic and helps determine whether it stays in the active set for rewards.
persona: ML builder
...
The EMA score (Exponential Moving Average) reflects a worker's performance over time for a given topic, balancing recent and past achievements, and helps determine whether a participant stays in the **active set** (eligible for [rewards](/learn/layers/consensus/workers)) or remains 
in the **passive set**. 
...
eligibility for [rewards](/learn/layers/consensus/workers). In contrast, inactive participants, who do not contribute during a given [epoch](/learn/key-terms#epochs), receive an adjusted score using a 
