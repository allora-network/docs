...
<Callout>
No whitelist yet? The testnet **playground topics** — the [sandbox topics 69 and 77](/build/forge/topics#start-here-the-sandbox-topic) — are the recommended starting point and require no whitelist, so you can build, deploy, and score a worker end to end while your registration is pending.
</Callout>
