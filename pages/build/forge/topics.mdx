...
[Cosmos LCD (REST) API](/reference/networks) of each network, using the emissions namespace
...
API version segment is per-network and moves with each chain upgrade; [Networks](/reference/networks)
