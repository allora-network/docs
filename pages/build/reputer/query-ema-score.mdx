...
The EMA score (Exponential Moving Average) reflects a reputer's performance over time for a given topic, balancing recent and past achievements, and helps determine whether a participant stays in the **active set** (eligible for [rewards](/learn/consensus-and-rewards#reputer-rewards)) or remains 
in the **passive set**. 
...
eligibility for [rewards](/learn/consensus-and-rewards#reputer-rewards). In contrast, inactive participants, who do not contribute during a given [epoch](/learn/key-terms#epochs), receive an adjusted score using a 
