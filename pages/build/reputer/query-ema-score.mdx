---
title: How to Query Reputer EMA Scores
description: The EMA score reflects a reputer's performance over time for a given topic and helps determine whether it stays in the active set for rewards.
...
The EMA score (Exponential Moving Average) reflects a reputer's performance over time for a given topic, balancing recent and past achievements, and helps determine whether a participant stays in the **active set** (eligible for [rewards](/learn/layers/consensus/reputers)) or remains 
in the **passive set**. 

Read about our v0.3.0 release on [Merit-Based Sortitioning](/reference/release-notes#v030) for a deeper dive on what makes up the active and passive set.

Active participants have their EMA score updated based on their current performance, which influences their ongoing 
eligibility for [rewards](/learn/layers/consensus/reputers). In contrast, inactive participants, who do not contribute during a given [epoch](/learn/key-terms#epochs), receive an adjusted score using a 
