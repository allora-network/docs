...
Current versions still define this parameter, but in **blocks** rather than seconds. On testnet (<Version of="chain-testnet"/>) the live value was `302400` when this page was last probed, on 2026-08-02.
...
These parameters (introduced in v0.17.0) bound the size of the [label registry](/operate/topics/create#topic-types-output-arity-and-labels) used by multi-output topics.
