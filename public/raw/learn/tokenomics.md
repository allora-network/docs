---
title: Allora Tokenomics
description: The Allora token (ALLO) is minted by the Allora Network to facilitate the exchange of value by network participants.
persona: Protocol researcher
verified_against: docs content as of 2024-07-31
...
- Token holders can [delegate stake](https://docs.allora.network/learn/key-terms#delegated-stake) to a reputer or network validator.
- Staking reputers, network validators, and delegating token holders receive rewards in ALLO.

### Reward Distribution

The network uses ALLO tokens to pay out rewards to participants. Participant rewards are explained in-depth in the [Consensus Layer](https://docs.allora.network/learn/consensus-and-rewards).
