...
description: Definitions of the key terms used across the Allora Network and its documentation.
...
A [network participant](https://docs.allora.network/learn/participants) in the Allora Network is an individual or entity that contributes and continuously adds value to the network by fulfilling specific roles.
