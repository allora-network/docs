...
- **A REST API** at `https://forge-data.allora.run/api` for datasets, columns, and rows — see the [Atlas API reference](https://docs.allora.network/build/atlas/api)
...
Acquiring the `public` tag is the first API call to make with a new key — the [API reference](https://docs.allora.network/build/atlas/api#step-1-acquire-the-public-tag) shows how, and the web UI and the Builder Kit's `AtlasDataManager` both do it automatically.
...
- Make your first queries: [Atlas API reference](https://docs.allora.network/build/atlas/api)
- Put the data to work: [build a price prediction worker](https://docs.allora.network/build/worker/sdk-py)
