...
description: Commands for pulling information about workers via allorad.
persona: ML builder
...
Below is a list of commands to understand how to pull information about workers via [`allorad`](https://docs.allora.network/get-started/cli#installing-allorad):
...
- **Description:** Return scores for a worker at a block height.
    - Scores determine how [worker rewards](https://docs.allora.network/learn/consensus-and-rewards#worker-rewards) are paid out.
...
### Use Case:
**Why use it?**
- Use this command to assess the [regret](https://docs.allora.network/learn/key-terms#regrets) associated with incorporating an inferer’s naive inference into a batch. Useful for analyzing how poorly an inference may perform within the context of the network’s aggregate inference for a topic.
