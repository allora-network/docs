...
| [`/llms-full.txt`](https://docs.allora.network/llms-full.txt) | Full text of every page in one file (~450 KB) | You want the whole corpus in one request |
...
- **Layout components are unwrapped.** Callouts, tabs, and card grids become
  ...
  dropped — it has nothing but its tag. One used mid-sentence becomes markdown
...
So a reader of this file should take the four top-level string values as the
