---
title: Setup Wallet
description: Follow the instructions here to install our CLI tool allorad, which is needed to create a wallet.
...
Follow the instructions [here](https://docs.allora.network/get-started/cli) to install our CLI tool `allorad`, which is needed to create a wallet.
...
Learn more about setting up keys [here](https://docs.cosmos.network/sdk/v0.50/user/run-node/keyring).
