---
title: Basic Usage
description: The Allora Network is a sophisticated ecosystem designed to facilitate various participants, including inference workers, forecasters, reputers, and validators, each playing a crucial role in the network's functionality and integrity.
persona: New Allora developer
verified_against: docs content as of 2025-02-03
...
Follow the tutorial [here](https://docs.allora.network/operate/topics/query-network-data#get-latest-available-network-inferences) to learn how to query an inference on-chain using the `allorad` CLI tool.
...
Follow the tutorial [here](https://docs.allora.network/reference/allorad#delegate-stake-to-a-reputer-for-a-topic) to learn how to delegate your stake to a reputer.
