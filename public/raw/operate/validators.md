---
title: Validators
description: Validators maintain the security and integrity of the Allora appchain.
persona: Validator operator
verified_against: docs content as of 2024-07-17; internal link targets re-checked on 2026-08-02
...
Validators [receive rewards](https://docs.allora.network/learn/consensus-and-rewards) based on the amount of stake they hold or have delegated to them.

## Learn More

Test run a validator of the Allora appchain by following the instructions [here](https://docs.allora.network/operate/validators/run-full-node).
