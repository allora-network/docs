...
description: Follow these steps to stake on a node in the Allora network, including running and syncing a full node, funding your account, and setting up your Validator for staking.
persona: Validator operator
verified_against: docs content as of 2024-08-27
...
- Successfully run and synced a full `allorad` node. Refer to [Running a Full Node](https://docs.allora.network/operate/validators/run-full-node) for detailed instructions.
...
For testnet environments, use the appropriate [faucet](https://docs.allora.network/get-started/setup-wallet#add-faucet-funds).
