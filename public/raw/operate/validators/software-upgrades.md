...
description: How to upgrade the Allora software version during hard forks.
...
off-chain participants such as workers and reputers run their own software. Each piece of software
...
7. Write a function that process the kv store or does whatever other migrations are necessary. Examples [here](https://github.com/allora-network/allora-chain/blob/main/x/emissions/migrations/v2/migrate.go) and [here](https://github.com/evmos/evmos/blob/v20.0.0/x/evm/migrations/v7/migrate.go).
...
Cosmos SDK Upgrade Module: [Documentation](https://docs.cosmos.network/sdk/v0.50/build/modules/upgrade)

Cosmovisor Process Manager Software [Documentation](https://docs.cosmos.network/sdk/v0.50/build/tooling/cosmovisor)

Cosmos SDK Gov Module: [Documentation](https://docs.cosmos.network/sdk/v0.50/build/modules/gov)
